...
def train(env: DjambiEnv, agent: DQNAgent, num_episodes: int = 1000, save_path: str = "models"):
    ...
    for episode in pbar:
        ...
        pbar.set_description(f"Episode {episode+1}/{num_episodes} - Reward: {episode_reward:.2f} - Epsilon: {agent.eps:.2f} - Wins: {wins}")
...
if __name__ == "__main__":
    ...
    env = DjambiEnv(render_mode=None)  # Set to "human" if you want to see the game
